...
class Basic_fluxfactor(Feature):
    def create_features(self, train_meta, test_meta):
        """
        train: meta-data
        test: meta-data
        """
        self.suffix = "fluxfactor"
...
class Basic_fluxfactor_passband(Feature):
    def create_features(self, train_meta, test_meta):
        """
        train: meta-data
        test: meta-data
...
if __name__ == '__main__':
    ...
    # f = Basic_fluxfactor('../../data/feature/')
    # f.run(train_meta, test_meta).save()

    # make Basic_fluxfactor_passband features
    f = Basic_fluxfactor_passband('../../data/feature/')
    f.run(train_meta, test_meta).save()
